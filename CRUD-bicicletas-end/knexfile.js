...
module.exports = {
  development: {
    ...
    connection: {
      ...
      password: process.env.DB_DEVELOPMENT_PASSWORD || 'rootpassword'
    },
    pool: {
      min: 2,
      max: 10
  ...
  production: {
    ...
    connection: {
      ...
      database: process.env.DB_PRODUCTION_NAME || 'test',
      user:  process.env.DB_PRODUCTION_USER || 'root',
      password: process.env.DB_PRODUCTION_PASSWORD || 'rootpassword'
    },
    pool: {
      min: 2,
      max: 10
